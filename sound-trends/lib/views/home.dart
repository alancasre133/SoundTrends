                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            ...
                            ' '+userdata!['display_name'], style: TextStyle(color: cons.green, fontSize: 40, fontWeight: FontWeight.w900)),
                        ],
                      ),
                    ),
                    Container(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (int index) {
          setState(() {
            ...
            if(_selectedIndex==1){
              Navigator.push(context, MaterialPageRoute(builder: (context) =>  stats(token: widget.token)));
            }
            if(_selectedIndex==2){
